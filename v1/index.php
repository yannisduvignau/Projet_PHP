...
<body>
    ...
    <script>
        function showDetails(cdData) {
            ...
            modalContent.innerHTML = `
                ...
                <form id="monFormulaire">
                    ...
                    <button type="button" name="add_to_cart" onclick="soumettreFormulaire()" class="btn-link">Ajouter au panier</button>
                </form>
        ...
        function soumettreFormulaire() {
            ...
            var formData = new FormData(document.getElementById('monFormulaire'));
